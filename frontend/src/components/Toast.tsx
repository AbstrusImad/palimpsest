        ...
        {toasts.map((t) => {
          ...
          return (
            <motion.div
              ...
              className="vellum gilt pointer-events-auto relative overflow-hidden rounded-lg p-3.5"
            ...
            >
              ...
              <div className="flex items-start gap-2.5 pl-1.5">
                ...
                <div className="min-w-0 flex-1">
                  <p className="text-sm font-semibold text-parchment">{t.title}</p>
                  {t.message && (
                  ...
                  {t.hash && (
                    <a
                      ...
                      className="mt-1.5 inline-flex items-center gap-1 font-mono text-[11px] text-astral hover:underline"
                    >
                      View on explorer
                  ...
                  {t.onRetry && (
                    <button
                      type="button"
                      onClick={t.onRetry}
                      className="mt-2 rounded border border-[var(--hairline-strong)] px-2.5 py-1 text-[11px] uppercase tracking-wider text-gold transition-colors hover:bg-[rgba(216,178,90,0.1)]"
                    >
                      Retry
                    </button>
                  )}
